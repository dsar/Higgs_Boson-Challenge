...
# Gradient descent
def test_GD(y,tX,ratio,gamma=0.01,max_iters=1000,w_initial=None):
	seed = 1
	...
	_, w = least_squares_GD(y_tr, tX_tr, w_initial,gamma,max_iters)
	s = score(tX_te, y_te, w)
	print(s)

# Stochastic gradient descent
def test_SGD(y,tX,ratio,gamma=0.01,max_iters=1000,batch_size=50,w_initial=None):
	seed = 1
	tX_tr, y_tr, tX_te, y_te = split_data(y, tX, ratio, seed)
	...
	_, w = least_squares_SGD(y_tr, tX_tr, w_initial, batch_size,gamma,max_iters)
	s = score(tX_te, y_te, w)
	print(s)
